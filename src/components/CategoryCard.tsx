  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 z-10">
        ...
        <p className="mt-2 text-sm text-neutral-200 line-clamp-2 opacity-90 transition-all duration-300 group-hover:text-white">
          {description}
        </p>

        {/* Call to Action Indicator */}
        <div className="mt-4 flex items-center gap-1.5 text-xs font-semibold text-white uppercase tracking-wider opacity-0 -translate-x-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0">
          Explore Board
